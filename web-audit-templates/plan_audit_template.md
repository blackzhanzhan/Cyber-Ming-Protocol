...
- Does each slice expose one `Commit Unit` and one `Commit Message`?
...
徐阁老，请审此折。不要代为施工，只审刀法。请判断：原子片是否够小，红绿灯是否够清，验收阶梯是否站得住，Commit Unit 与 Commit Message 是否守法。不许顺着执行位讲故事，只许给出：可批 / 不可批、主风险、缩刀建议。
