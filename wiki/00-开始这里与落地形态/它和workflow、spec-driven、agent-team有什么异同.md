...
如果说 [`三者关系`](协议、Skill-与-Web-审计模板：三者关系.md) 先帮你分清“这个仓库到底交付了什么”，那么这页回答的就是下一步：
...
- [三者关系](协议、Skill-与-Web-审计模板：三者关系.md)：先分清比较对象，再回来对位主流方案
- [最小闭环指南](复制即用提示词包.md)：回到第一层主入口
- [最小稳定闭环指南](最小稳定闭环指南.md)：如果你已经跑通第一层，继续进入第二层
