...
这页是第一层“最小闭环”的补概念页，不是与两层学习地图并列的新入口。
...
- 如果你要回到第一层主入口，继续看 [`最小闭环指南`](复制即用提示词包.md)
- 如果你想先脑补一轮最小闭环，继续看 [`30 秒最小示例`](30-秒最小示例.md)
- 如果你已经跑通第一层，准备进入第二层，继续看 [`最小稳定闭环指南`](最小稳定闭环指南.md)
- 如果你已经明确要处理 IDE 端或 Web 端接入，再分别看 [`Skill 接入指南`](Skill接入指南.md) 与 [`Web 审计端固定提示词与专有应用指南`](Web审计端固定提示词与专有应用指南.md)
