...
- [Spotting the Problem: Why Many People Mistake High Governance for Low Throughput](#spotting-the-problem-why-many-people-mistake-high-governance-for-low-throughput)
- [Explaining the Problem: Why Throughput in the Agent Era Is Naturally Pulsed](#explaining-the-problem-why-throughput-in-the-agent-era-is-naturally-pulsed)
- [Solving the Problem: How Pulse Enfeoffment Turns Waiting Time into Governance Time](#solving-the-problem-how-pulse-enfeoffment-turns-waiting-time-into-governance-time)
...
This move is directly connected to [Worktree Enfeoffment: Fiefs, Entering the Capital, and Mainline Purity](worktree-enfeoffment.md).
