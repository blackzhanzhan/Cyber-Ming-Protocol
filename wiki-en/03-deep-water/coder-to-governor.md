...
- [Spotting the Problem: Why Just Knowing How to Code Is No Longer Enough](#spotting-the-problem-why-just-knowing-how-to-code-is-no-longer-enough)
- [Explaining the Problem: Why the Structure of Human Ability Gets Rewritten](#explaining-the-problem-why-the-structure-of-human-ability-gets-rewritten)
- [Solving the Problem: The Six Capabilities This Protocol Really Requires](#solving-the-problem-the-six-capabilities-this-protocol-really-requires)
- [How This Differs from What Black-Box Schools Ask of People](#how-this-differs-from-what-black-box-schools-ask-of-people)
...
This has already been explained in [Dual-track Isolation Audit and Human-Centered Sovereignty](dual-track-audit.md). The executor can grow faster and faster. It can even outpace humans in pushing workflows and stacking implementation. But it cannot naturally own the power to declare what counts as complete.
...
This point was also established in [Why AI Coding Has Blurred the Boundary Between CS and Management](../01-why/cs-vs-management.md). Copying logs, forwarding diffs, cutting context, and sending assertions out for re-audit used to look like support work in traditional engineering. In AI coding, those actions directly determine the world the executor and auditor are allowed to see.
...
[Cyber Cognitive Debt: The Widening Gap, Warning Signals, and Credible Repayment](cognitive-debt.md) already made this clear: AI makes system change move faster than trustworthy human understanding, so cognitive debt keeps being generated.
...
That is why [White-box Physical Reconciliation: What Counts as Completion Fact](../02-how/white-box-reconciliation.md) sits so high in the protocol. It requires the developer not only to "understand code," but also to define completion, force out physical evidence, and judge truth from falsehood.
