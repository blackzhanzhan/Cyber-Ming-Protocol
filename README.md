...
小黄龙代表人类中枢与终裁，严嵩代表执行位与越权风险，徐阶代表独立审计与纠偏。这个角色系统不是装饰，而是帮助你一眼记住：谁负责推进，谁负责审计，谁保留主权。
...
Xiao Huanglong stands for the human hub and final ruling, Yan Song stands for execution pressure and drift risk, and Xu Jie stands for independent audit and correction. The cast is not decoration. It is there to make the governance split memorable at a glance.
