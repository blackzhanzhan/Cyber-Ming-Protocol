...
- 你可能正被黑盒拖着走：越来越不理解代码，越来越说不清 AI 改了什么，项目越来越失控。
- 你可能正被过早冻结的 workflow 卡住：认真用过 workflow / spec-driven，却开始觉得自己在维护 spec，而不是继续做产品。
- 如果你已经有这种感觉，先别从头线性读完，直接按下面目录跳。

## 快速目录

- [我最快应该如何进入帝王 Coding？](#fast-imperial-coding)
- [这是什么](#what-this-is)
- [它解决什么问题](#what-it-solves)
- [GitHub Wiki 人类 Home](https://github.com/blackzhanzhan/Cyber-Ming-Protocol/wiki)

<a id="fast-imperial-coding"></a>
## 我最快应该如何进入帝王 Coding？

这条最快入口更适合已经阅读过核心思想、对基本流程已有直觉性认知的人。若你还没有这层认知，先去 [GitHub Wiki 人类 Home](https://github.com/blackzhanzhan/Cyber-Ming-Protocol/wiki) 或 `00` 前置层，再回来走这条快路。

还要再记一条限制：由于模型能力有差异，尤其在没有安装项目 skill 的情况下，这个一键进入帝王 Coding 不能保证 agent 立刻严格遵循角色边界。已经观察到有模型会先承认“我会先交清单”，但真正收到需求后仍直接写代码。

所以你不一定要完整采用手工做法，但你必须先理解手工做法的流程。因为只有这样，你才知道何时该打断、为什么该打断，以及自己的中断权和圣裁权该怎样一直握在手里。
