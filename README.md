...
| 模块 | 解决什么问题 |
|------|-------------|
| [00-入口](wiki/00-开始这里与落地形态/) | 两层学习地图：先跑通最小闭环，再进入最小稳定闭环，以及各自的配套页 |
...
**00-入口：**
- [最小闭环指南](wiki/00-开始这里与落地形态/复制即用提示词包.md)：第一层父页；先手工跑通一轮最小闭环，宿主能力差异放在页内分支里处理
- [30 秒最小示例](wiki/00-开始这里与落地形态/30-秒最小示例.md)：第一层配套页；30 秒脑补一轮怎么跑
- [让执行位与审计位自举入场](wiki/00-开始这里与落地形态/让执行位与审计位自举入场.md)：第一层配套页；理解最小闭环后再授位
- [三者关系](wiki/00-开始这里与落地形态/协议、Skill-与-Web-审计模板：三者关系.md)：第一层配套页；分清协议、Skill、Web 审计模板
- [异同对比](wiki/00-开始这里与落地形态/它和workflow、spec-driven、agent-team有什么异同.md)：第一层配套页；分清它和 workflow/spec-driven/agent-team 的关系
- [最小稳定闭环指南](wiki/00-开始这里与落地形态/最小稳定闭环指南.md)：第二层父页；定义什么叫双端同时成立的稳定闭环
- [Skill 接入指南](wiki/00-开始这里与落地形态/Skill接入指南.md)：第二层子指南；只解决 IDE 端那一半
- [Web 审计端固定提示词与专有应用指南](wiki/00-开始这里与落地形态/Web审计端固定提示词与专有应用指南.md)：第二层子指南；只解决 Web 端那一半
...
|--------|----------------|
| [00-Entry](wiki-en/00-entry/) | A two-layer learning map: first run the minimal loop, then enter the minimal stable loop, with support pages under each layer |
...
**00-Entry:**
- [Minimal Loop Guide](wiki-en/00-entry/prompt-pack.md): the Layer 1 parent page; run one manual minimal loop first, with host-capability differences handled inside the page
- [30-Second Demo](wiki-en/00-entry/30-second-demo.md): a Layer 1 support page for a 30-second mental simulation
- [Bootstrap](wiki-en/00-entry/bootstrap.md): a Layer 1 support page for handing repo law to the executor and auditor after you understand the loop
- [Three Things](wiki-en/00-entry/three-things.md): a Layer 1 support page that separates the protocol, Skill, and Web audit templates
- [Comparison](wiki-en/00-entry/comparison.md): a Layer 1 support page that positions this protocol against workflow, spec-driven, and agent team
- [Minimal Stable Loop Guide](wiki-en/00-entry/stable-loop-guide.md): the Layer 2 parent page; defines what a stable dual-end loop means
- [Skill Guide](wiki-en/00-entry/skill-guide.md): the Layer 2 IDE-side sub-guide
- [Web Auditor App Guide](wiki-en/00-entry/web-auditor-app-guide.md): the Layer 2 Web-side sub-guide
