...
这套协议已经整理成中英双语静态教学 wiki，可作为项目门面和完整学习入口：

- 在线地址：<https://blackzhanzhan.github.io/Cyber-Ming-Protocol/>
- 本地预览：打开 `site/dist/zh/index.html` 或 `site/dist/en/index.html`
- 重新构建与校验：
...
The protocol is now available as a bilingual static teaching wiki that works as both the project front door and the full learning path:

- Live site: <https://blackzhanzhan.github.io/Cyber-Ming-Protocol/>
- Local preview: open `site/dist/zh/index.html` or `site/dist/en/index.html`
